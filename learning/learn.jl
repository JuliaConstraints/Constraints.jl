...
const DEFAULT_COMPOSITIONS_PATH = joinpath(dirname(pathof(Constraints)), "compositions")

const DEFAULT_DATA_PATH = joinpath(dirname(pathof(Constraints)), "..", "learning", "data.json")

function learn_from_icn(;
    targets = DEFAULT_TARGETS,
    config = DEFAULT_CONFIG,
    path = DEFAULT_COMPOSITIONS_PATH,
